...
class VBEPostings:
    ...
    def vb_encode_number(number):
        ...
        bytes_list = []
        while True:
            bytes_list.insert(0, number % 128)  # prepends
            if number < 128:
                break
            number = number // 128
    ...
    def vb_encode(list_of_numbers):
        ...
        for num in list_of_numbers:
            vb_num = VBEPostings.vb_encode_number(num)
            bytestream.extend(vb_num)
    ...
    def encode(postings_list):
        ...
        gap_based_list = [postings_list[0]] + [postings_list[i] - postings_list[i-1] for i in range(1, len(postings_list))]

        return bytes(VBEPostings.vb_encode(gap_based_list))
    ...
    def decode(encoded_postings_list):
        ...
        return list(itertools.accumulate(gap_based_list))
